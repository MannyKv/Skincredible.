...
public class SunscreenDataProvider {
    ...
    public static Map<String, ArrayList<Object>> getSunscreenInfo() {
        ...
        sunscreenInfo.put("sun1", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        16.99,
                        new Category("Aqua Sun Gel", "sun1", "sun.png"),
        ...
        sunscreenInfo.put("sun2", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        35.0,
                        new Category("Birch Juice Moisturising Sunscreen", "sun2", "sun.png"),
        ...
        sunscreenInfo.put("sun3", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        21.0,
                        new Category("Aloe Soothing Sun Scream", "sun3", "sun.png"),
        ...
        sunscreenInfo.put("sun4", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        28.0,
                        new Category("Every Sun Day Moisturising Sun SPF50", "sun4", "sun.png"),
        ...
        sunscreenInfo.put("sun5", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        22.0,
                        new Category("All Around Safe Block Essence Sun SPF45", "sun5", "sun.png"),
        ...
        sunscreenInfo.put("sun6", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        35.0,
                        new Category("1025 Dokdo Sun Cream SPF50+", "sun6", "sun.png"),
        ...
        sunscreenInfo.put("sun7", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        35.0,
                        new Category("Birch Juice Moisturising Mild-Up Sunscreen SPF50+", "sun7", "sun.png"),
        ...
        sunscreenInfo.put("sun8", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        35.0,
                        new Category("365 Derma Relief Sun Cream SPF50+", "sun8", "sun.png"),
                        new ArrayList<String>(Arrays.asList("Normal", "Sensitive", "Combination")),
                        "Physical",
                        "SPF50+",
                        "Apply evenly to areas exposed to ultraviolet rays at the last stage of skincare."
        ...
        sunscreenInfo.put("sun9", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        38.0,
                        new Category("Daily Go-To Sunscreen SPF50+", "sun9", "sun.png"),
        ...
        sunscreenInfo.put("sun10", new ArrayList<Object>(
                Arrays.asList(
                        ...
                        28.0,
                        new Category("Every Sun Day Mind Sun SPF43", "sun1", "sun.png"),
    ...
    public static List<IItem> getSunscreen() {
        ...
        for (String key : sunscreenInfo.keySet()) {
            ...
            ArrayList<String> imageName = (ArrayList<String>) sunscreenInfo.get(key).get(2);
            double price = (double) sunscreenInfo.get(key).get(3);
            Category category = (Category) sunscreenInfo.get(key).get(4);
            ...
            Sunscreen sunscreen = new Sunscreen(key, name, brand, imageName, price, category, skinType, sunscreenType, spf, howToUse);
