...
public class Moisturiser extends Item {
    ...
    public Moisturiser(String id, String name, String brand, ArrayList<String> imageName, double price, String categoryName, ArrayList<String> skinType, String moisturiserType, String howToUse, String timeToUse) {
