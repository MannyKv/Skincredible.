...
public class Sunscreen extends Item {
    ...
    public Sunscreen(String id, String name, String brand, ArrayList<String> imageName, double price, String categoryName, ArrayList<String> skinType, String sunscreenType, String spf, String howToUse) {
